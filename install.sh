...
echo "=========================="
apt update && apt -y install python3 python3-pip python3-pygame supervisor omxplayer ntfs-3g exfat-fuse ffmpeg fbi python3-pil
...
(sudo crontab -l ; sudo echo "55 1 * * * sudo shutdown -h") | crontab -
